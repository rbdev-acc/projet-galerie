...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\GalerieController' => 'getGalerieControllerService',
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\GalerieController', 'App\\Controller\\HomeController', 'App\\Controller\\RegistrationController', 'App\\Controller\\SecurityController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'victor_prdh_recaptcha.google_site_key' => $container->getEnv('GOOGLE_RECAPTCHA_SITE_KEY'),
            'victor_prdh_recaptcha.google_secret_key' => $container->getEnv('GOOGLE_RECAPTCHA_SECRET_KEY'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles_metadata' => [
                ...
                'RecaptchaBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/victor-prdh/recaptcha-bundle/src'),
            ...
            'twig.form.resources' => [
                0 => '@Recaptcha/form/recaptcha.html.twig',
